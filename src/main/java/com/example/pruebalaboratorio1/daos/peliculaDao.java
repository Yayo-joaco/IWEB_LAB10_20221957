...
public class peliculaDao extends baseDao{
    ...
    public void crearPelicula(String titulo, String director, int anoPublicacion, double rating, double boxOffice, int idGenero, int idStreaming) {
        String sql = "INSERT INTO pelicula (titulo,director,anoPublicacion,rating,boxOffice,idGenero,duracion,premioOscar,idStreaming)" + " VALUES (?,?,?,?,?,?,?,?,?);";
